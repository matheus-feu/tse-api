...
class ConsultaColigacao(Base):
    __tablename__ = "consulta_coligacao"
    ...
    ds_composicao_coligacao = Column(String(197), nullable=True)
    cd_situacao_legenda = Column(String(2), nullable=True)
    ds_situacao = Column(String(22), nullable=True)
