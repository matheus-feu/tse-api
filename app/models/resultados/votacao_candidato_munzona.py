...
class VotacaoCandidatoMunZona(Base):
    ...
    nm_tipo_eleicao = Column(String(30), nullable=True)
    nr_turno = Column(Integer, nullable=True)
    cd_eleicao = Column(Integer, nullable=True)
    ds_eleicao = Column(String(50), nullable=True)
    ...
    ds_situacao_julgamento = Column(String(50), nullable=True)
    cd_situacao_cassacao = Column(Integer, nullable=True)
    ds_situacao_cassacao = Column(String(30), nullable=True)
    cd_situacao_dconst_diploma = Column(Integer, nullable=True)
    ds_situacao_dconst_diploma = Column(String(30), nullable=True)
    ...
    nm_partido = Column(String(50), nullable=True)
    ...
    ds_composicao_federacao = Column(String(50), nullable=True)
    ...
    ds_sit_tot_turno = Column(String(50), nullable=True)
